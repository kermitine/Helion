...
- EN CAN debugging (PCAN + CANable candleLight/gs_usb): [`docs/en/can_debugging.md`](en/can_debugging.md)
- 中文 CAN 调试（PCAN + CANable candleLight/gs_usb）: [`docs/zh/can_debugging.md`](zh/can_debugging.md)
